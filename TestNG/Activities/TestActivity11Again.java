...
public class TestActivity11Again {
	//Driver Object
	WebDriver driver;
	WebDriverWait wait;
	...
	public void pageTitleTest() {
		...
		//Assertion
		Assert.assertEquals(pageTitle, "Selenium: Simple Form"); 
	...
	public static List<List<String>> readExcel(String filePath) {
		...
		try {
            ...
            for(Row cells: sheet ) {
            	// Temp variable
                List<String> rowData = new ArrayList<String>();for (Cell cell : cells) {
                    // Store row data
    ...
    public static Object[][] signUpInfo() {
        String filePath = "src/test/resources/input.xlsx";
